...
# Logfile location
LOG_FILE=/home/forge/logs/video-transcoding-api-stage.log
...
pipenv run python spr get -e stage -r ECS -s video-transcoding-api-stage --secure
# Export all the secrets as env variables
# TODO: Make this dynamic, and not hard coded to "stage"
export $(cat secrets/video-transcoding-api-stage.env | xargs)

# Change to project dir
cd /home/forge/video-transcoding-api.stage.sportsrecruits.com
